    ...
    <main>
        ...
        <div class="main-container">
            ...
            <form id="locationForm">
                ...
                <div>
                    <input type="password" name="authority" id="authority" maxlength="10" size="12"
            ...
            data.forEach(location => {
                if (location.type === 'toilet') {
                    marker = L.marker([location.lat, location.lng], {
                        ...
                        .bindPopup(
                            `<p><h3>${location.type}</h3>Women's: ${location.women}<br>Men's: ${location.men}</p>`
                            );
                } else {
                    marker = L.marker([location.lat, location.lng], {
                            icon: wifiIcon
                        ...
                        .bindPopup(
                            `<p><h3>${location.type}</h3>Wifi Name: ${location.name}<br>Password: ${location.password}`
                            );
                }
                marker.addTo(map);
            });
